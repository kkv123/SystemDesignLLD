package factoryDesignPattern.abstractf;

// --- Product 1 --> Burger ---
interface Burger {
    void prepare();
}
//---------------------------creating basic burger ----------------------------------
